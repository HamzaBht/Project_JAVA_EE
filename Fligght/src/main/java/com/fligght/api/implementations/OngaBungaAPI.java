    ...
    public class CabineAdapter implements JsonbAdapter<Cabine, JsonObject> {
        ...
        public Cabine adaptFromJson(JsonObject jsonObject) throws Exception {
            ...
            switch (apiCabineType) {
                case "Première":
                    ourCabineType = CabineClass.FirstClass;
                    break;
                case "Affaire":
                    ourCabineType = CabineClass.BusinessClass;
                    break;
                case "Éco-premium":
                    ourCabineType = CabineClass.PremiumEconomy;
                    break;
                case "Économie":
                    ourCabineType = CabineClass.Economy;
                    break;
                default:
                    ourCabineType = CabineClass.OTHER;
                    break;
            }
