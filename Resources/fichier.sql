...
CREATE TABLE IF NOT EXISTS `mydb`.`Ville` (
  ...
  PRIMARY KEY (`idVille`),
  INDEX `fk_Ville_Pays1_idx` (`Pays_idpays` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Aeroport` (
  ...
  INDEX `fk_Aeroport_Ville1_idx` (`Ville_idVille` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Vol` (
  ...
  PRIMARY KEY (`idVol`),
  INDEX `fk_Vol_Aeroport_idx` (`Aeroport_idAeroportDepart` ASC) ,
  INDEX `fk_Vol_Aeroport1_idx` (`Aeroport_idAeroportArrivee` ASC) ,
  INDEX `fk_Vol_Cabine1_idx` (`Cabine_idCabine` ASC) ,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Reservation` (
  ...
  `Vol_Aeroport_idAeroport` INT NOT NULL,
  `Vol_Aeroport_idAeroport1` INT NOT NULL,
  `Client_idClient` INT NOT NULL,
  PRIMARY KEY (`idReservation`),
  INDEX `fk_Reservation_Vol1_idx` (`Vol_idVol` ASC, `Vol_Aeroport_idAeroport` ASC, `Vol_Aeroport_idAeroport1` ASC) ,
  INDEX `fk_Reservation_Client1_idx` (`Client_idClient` ASC) ,
  CONSTRAINT `fk_Reservation_Vol1`
    FOREIGN KEY (`Vol_idVol` , `Vol_Aeroport_idAeroport` , `Vol_Aeroport_idAeroport1`)
    REFERENCES `mydb`.`Vol` (`idVol` , `Aeroport_idAeroportDepart` , `Aeroport_idAeroportArrivee`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
